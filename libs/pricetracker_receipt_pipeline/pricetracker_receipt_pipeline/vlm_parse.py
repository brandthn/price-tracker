...
from pricetracker_receipt_pipeline.constants import OUTPUT_DATE_FORMAT, ProductField, TicketField
...
def _looks_like_store_name(value: str) -> bool:
    from pricetracker_receipt_pipeline.vlm_validate import looks_like_store_name
