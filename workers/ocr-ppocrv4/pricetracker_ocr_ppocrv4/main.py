"""FastAPI app worker OCR backend PP-OCRv4 mobile — POST /push (Pub/Sub `ocr-ppocrv4`).
...
async def lifespan(app: FastAPI):
    ...
    # Le backend est construit une seule fois : PP-OCRv4 mobile charge ses modèles
    # (baked dans l'image, fallback paddle_dynamic). Un échec ici fait échouer le
...
app = FastAPI(
    title="prt-prod-worker-ocr-ppocrv4",
    docs_url=None,
    redoc_url=None,
    lifespan=lifespan,
)
