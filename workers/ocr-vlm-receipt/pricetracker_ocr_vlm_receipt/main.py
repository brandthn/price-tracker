"""FastAPI app worker OCR backend receipt-vlm-500m — POST /push (Pub/Sub `ocr-vlm-receipt`).
...
async def lifespan(app: FastAPI):
    ...
    # Checkpoint `.pt` depuis le bucket models (cold start). Un échec ici fait
...
app = FastAPI(
    title="prt-prod-worker-ocr-vlm-receipt",
    docs_url=None,
    redoc_url=None,
    lifespan=lifespan,
)
