...
export function Storefront(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
      ...
      {...props}
    >
      <path d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.35M3.75 21V9.35m0 0a3 3 0 0 0 3.75-.616A2.99 2.99 0 0 0 9.75 9.75c.9 0 1.7-.393 2.25-1.016a2.99 2.99 0 0 0 2.25 1.016c.9 0 1.7-.393 2.25-1.016a3 3 0 0 0 3.75.615m-16.5 0a3 3 0 0 1-.62-4.72l1.19-1.19A1.5 1.5 0 0 1 5.38 3h13.24a1.5 1.5 0 0 1 1.06.44l1.19 1.19a3 3 0 0 1-.62 4.72M6.75 18h3.75a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H6.75a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Z" />
    </svg>
  );
}
